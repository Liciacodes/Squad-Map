...
export default function App() {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      {screen === "map" && event && (
        <>
          <div className="fixed top-0 left-0 right-0 z-[1000] bg-white shadow-md px-4 pb-3 flex flex-col gap-1 overflow-y-auto max-h-[45vh]" 
          ...
          <button
            ...
            className="fixed right-4 z-[999] bg-white rounded-full w-12 h-12 shadow-lg flex items-center justify-center hover:bg-gray-50 transition-colors"
            style={{ bottom: 'calc(50vh + max(env(safe-area-inset-bottom), 16px))' }}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <circle cx="12" cy="12" r="3" />
              <path d="M12 2v3M12 19v3M2 12h3M19 12h3" />
